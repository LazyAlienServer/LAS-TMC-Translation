...
<template>
  <div class="flex flex-row justify-between">
    ...
    <!-- Left Section -->
    <div class="flex flex-row justify-center gap-2 p-2 items-stretch w-1/6">
      <router-link
          :to="{ name: 'my-articles' }"
          class="editor-actions-btn group"
      >
        <ArrowLeftToLine size="17"/>
        <span class="editor-toolbar-btn-tooltip">
          Back to my articles
        </span>
      </router-link>
    </div>
    ...
    <!-- Center Section -->
    <div class="flex flex-row justify-center gap-2 p-2 items-stretch w-4/6">
      ...
      <div class="w-[0.1px] mx-1 bg-black"></div>
    ...
    <div class="flex flex-row justify-center gap-2 p-2 items-stretch w-1/6">
      ...
      <div ref="actionRootElement" class="relative">
        ...
        >
          ...
          <button
              type="button"
              class="editor-actions-dropdown-btn"
              @click="$emit('delete')"
          >
